...
The codebase is generated using ADL CLI 0.19.5 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.19.5 or compatible version for regeneration
