...
type SearchN8nDocsParams struct {
	Query    string `json:"query"`
	NodeType string `json:"node_type,omitempty"`
	Category string `json:"category,omitempty"`
}

// SearchN8nDocsTool implements the search-n8n-docs skill
type SearchN8nDocsTool struct{}

// GetName returns the tool name
func (t *SearchN8nDocsTool) GetName() string {
	return "search-n8n-docs"
}

// GetDescription returns the tool description
func (t *SearchN8nDocsTool) GetDescription() string {
	return "Search through N8N node documentation to find relevant information about specific nodes, their parameters, and usage patterns"
}

// GetParameters returns the tool parameters schema
func (t *SearchN8nDocsTool) GetParameters() map[string]any {
...
func (t *SearchN8nDocsTool) Execute(ctx context.Context, params map[string]any) (string, error) {
	...
	if nodeType, ok := params["node_type"].(string); ok {
